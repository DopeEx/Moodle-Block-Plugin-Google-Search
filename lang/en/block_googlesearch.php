...
$string['googlesearch'] = 'Google Search';
$string['googlesearch:addinstance'] = 'Add a new block that displays 10 google search results for "moodle blocks".';
$string['googlesearch:myaddinstance'] = 'Add a new block to the My Moodle page';
